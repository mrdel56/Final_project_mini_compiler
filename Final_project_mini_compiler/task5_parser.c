...
{
       0,    62,    62,    66,    67,    71,    72,    76,    77,    81,
      82,    83,    84,    85,    89,    90,    94,    95,    96,    97,
      98,   102,   103,   104,   105,   109,   110,   118,   124,   118,
     137,   138,   142,   147,   142,   159,   160,   164,   172,   173,
     174,   175,   176,   177,   181,   186,   191,   195,   200,   205,
     209,   210,   211,   216,   221
};
#endif
...
#line 105 "task5_parser.y"
                                    { gen("=", (yyvsp[-1].str), "", (yyvsp[-3].str)); }
#line 1230 "task5_parser.c"
    break;

  case 25: /* assignment: ID ASSIGN expr SEMI  */
#line 109 "task5_parser.y"
                        { gen("=", (yyvsp[-1].str), "", (yyvsp[-3].str)); }
#line 1236 "task5_parser.c"
    break;

  case 26: /* assignment: ID LBRACKET expr RBRACKET ASSIGN expr SEMI  */
#line 110 "task5_parser.y"
                                                 {
        char tmp[100];
        sprintf(tmp, "%s[%s]", (yyvsp[-6].str), (yyvsp[-4].str));
        gen("=", (yyvsp[-1].str), "", tmp);
    }
#line 1246 "task5_parser.c"
    break;

  case 27: /* $@1: %empty  */
#line 118 "task5_parser.y"
                               {
...
#line 1258 "task5_parser.c"
    break;

  case 28: /* $@2: %empty  */
#line 124 "task5_parser.y"
                              {
        char *Lend = new_label();
        gen("goto", "", "", Lend);
...
#line 1290 "task5_parser.c"
    break;

  case 33: /* $@4: %empty  */
#line 147 "task5_parser.y"
                              {
        char *Lend = new_label();
        gen("ifFalse", (yyvsp[-1].str), "", Lend);
        strcpy(stack[sp].end_label, Lend);
    }
#line 1300 "task5_parser.c"
    break;

  case 34: /* while_stmt: WHILE $@3 LPAREN condition RPAREN $@4 LBRACE stmt_list RBRACE  */
#line 151 "task5_parser.y"
                              {
        gen("goto", "", "", stack[sp].false_label);
        gen("Label", "", "", stack[sp].end_label);
        sp--;
    }
#line 1310 "task5_parser.c"
    break;

  case 35: /* return_stmt: RETURN expr SEMI  */
#line 159 "task5_parser.y"
                     { gen("return", (yyvsp[-1].str), "", ""); }
#line 1316 "task5_parser.c"
    break;

  case 36: /* return_stmt: RETURN SEMI  */
#line 160 "task5_parser.y"
                  { gen("return", "", "", ""); }
#line 1322 "task5_parser.c"
    break;

  case 37: /* condition: expr relop expr  */
#line 164 "task5_parser.y"
                    {
        char *tmp = new_temp();
        gen((yyvsp[-1].str), (yyvsp[-2].str), (yyvsp[0].str), tmp);
        (yyval.str) = tmp;
    }
#line 1332 "task5_parser.c"
    break;

  case 38: /* relop: LT  */
#line 172 "task5_parser.y"
       { (yyval.str) = strdup("<"); }
#line 1338 "task5_parser.c"
    break;

  case 39: /* relop: GT  */
#line 173 "task5_parser.y"
         { (yyval.str) = strdup(">"); }
#line 1344 "task5_parser.c"
    break;

  case 40: /* relop: LE  */
#line 174 "task5_parser.y"
         { (yyval.str) = strdup("<="); }
#line 1350 "task5_parser.c"
    break;

  case 41: /* relop: GE  */
#line 175 "task5_parser.y"
         { (yyval.str) = strdup(">="); }
#line 1356 "task5_parser.c"
    break;

  case 42: /* relop: EQ  */
#line 176 "task5_parser.y"
         { (yyval.str) = strdup("=="); }
#line 1362 "task5_parser.c"
    break;

  case 43: /* relop: NE  */
#line 177 "task5_parser.y"
         { (yyval.str) = strdup("!="); }
#line 1368 "task5_parser.c"
    break;

  case 44: /* expr: expr PLUS term  */
#line 181 "task5_parser.y"
                   {
        char *tmp = new_temp();
        gen("+", (yyvsp[-2].str), (yyvsp[0].str), tmp);
        (yyval.str) = tmp;
    }
#line 1378 "task5_parser.c"
    break;

  case 45: /* expr: expr MINUS term  */
#line 186 "task5_parser.y"
                      {
        char *tmp = new_temp();
        gen("-", (yyvsp[-2].str), (yyvsp[0].str), tmp);
        (yyval.str) = tmp;
    }
#line 1388 "task5_parser.c"
    break;

  case 46: /* expr: term  */
#line 191 "task5_parser.y"
           { (yyval.str) = (yyvsp[0].str); }
#line 1394 "task5_parser.c"
    break;

  case 47: /* term: term MUL factor  */
#line 195 "task5_parser.y"
                    {
        char *tmp = new_temp();
        gen("*", (yyvsp[-2].str), (yyvsp[0].str), tmp);
        (yyval.str) = tmp;
    }
#line 1404 "task5_parser.c"
    break;

  case 48: /* term: term DIV factor  */
#line 200 "task5_parser.y"
                      {
        char *tmp = new_temp();
        gen("/", (yyvsp[-2].str), (yyvsp[0].str), tmp);
        (yyval.str) = tmp;
    }
#line 1414 "task5_parser.c"
    break;

  case 49: /* term: factor  */
#line 205 "task5_parser.y"
             { (yyval.str) = (yyvsp[0].str); }
#line 1420 "task5_parser.c"
    break;

  case 50: /* factor: LPAREN expr RPAREN  */
#line 209 "task5_parser.y"
                       { (yyval.str) = (yyvsp[-1].str); }
#line 1426 "task5_parser.c"
    break;

  case 51: /* factor: ID  */
#line 210 "task5_parser.y"
         { (yyval.str) = (yyvsp[0].str); }
#line 1432 "task5_parser.c"
    break;

  case 52: /* factor: NUM  */
#line 211 "task5_parser.y"
          {
        char *buf = (char*)malloc(16);
        sprintf(buf, "%d", (yyvsp[0].num));
        (yyval.str) = buf;
    }
#line 1442 "task5_parser.c"
    break;

  case 53: /* factor: FLOAT_NUM  */
#line 216 "task5_parser.y"
                {
        char *buf = (char*)malloc(16);
        sprintf(buf, "%.2f", (yyvsp[0].fnum));
        (yyval.str) = buf;
    }
#line 1452 "task5_parser.c"
    break;

  case 54: /* factor: ID LBRACKET expr RBRACKET  */
#line 221 "task5_parser.y"
                                {
        char *buf = (char*)malloc(64);
        sprintf(buf, "%s[%s]", (yyvsp[-3].str), (yyvsp[-1].str));
        (yyval.str) = buf;
    }
#line 1462 "task5_parser.c"
    break;


#line 1466 "task5_parser.c"
