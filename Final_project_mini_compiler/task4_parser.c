...
{
       0,    76,    76,    83,    87,    91,    96,   104,   108,   112,
     119,   120,   121,   122,   123,   127,   136,   140,   141,   142,
     143,   144,   148,   152,   158,   164,   172,   177,   186,   189,
     198,   204,   207,   213,   219,   220,   221,   222,   223,   224,
     228,   231,   234,   238,   241,   244,   248,   249,   253,   258,
     263
};
#endif
...
#line 1413 "task4_parser.c"
    break;

  case 26: /* assignment: ID ASSIGN expr SEMI  */
#line 172 "task4_parser.y"
                        {
...
#line 1485 "task4_parser.c"
  ...
  case 34: /* relop: LT  */
#line 219 "task4_parser.y"
       { (yyval.node) = create_node("Relop", "<", NULL, NULL); }
#line 1491 "task4_parser.c"
    break;

  case 35: /* relop: GT  */
#line 220 "task4_parser.y"
         { (yyval.node) = create_node("Relop", ">", NULL, NULL); }
#line 1497 "task4_parser.c"
    break;

  case 36: /* relop: LE  */
#line 221 "task4_parser.y"
         { (yyval.node) = create_node("Relop", "<=", NULL, NULL); }
#line 1503 "task4_parser.c"
    break;

  case 37: /* relop: GE  */
#line 222 "task4_parser.y"
         { (yyval.node) = create_node("Relop", ">=", NULL, NULL); }
#line 1509 "task4_parser.c"
    break;

  case 38: /* relop: EQ  */
#line 223 "task4_parser.y"
         { (yyval.node) = create_node("Relop", "==", NULL, NULL); }
#line 1515 "task4_parser.c"
    break;

  case 39: /* relop: NE  */
#line 224 "task4_parser.y"
         { (yyval.node) = create_node("Relop", "!=", NULL, NULL); }
#line 1521 "task4_parser.c"
    break;
...
#line 1537 "task4_parser.c"
  ...
  case 42: /* expr: term  */
#line 234 "task4_parser.y"
           { (yyval.node) = (yyvsp[0].node); }
#line 1543 "task4_parser.c"
    break;

  case 43: /* term: term MUL factor  */
#line 238 "task4_parser.y"
                    {
        (yyval.node) = create_node("*", "", (yyvsp[-2].node), (yyvsp[0].node));
    }
...
#line 1559 "task4_parser.c"
  ...
  case 45: /* term: factor  */
#line 244 "task4_parser.y"
             { (yyval.node) = (yyvsp[0].node); }
#line 1565 "task4_parser.c"
    break;

  case 46: /* factor: LPAREN expr RPAREN  */
#line 248 "task4_parser.y"
                       { (yyval.node) = (yyvsp[-1].node); }
#line 1571 "task4_parser.c"
    break;
...
int count_dimensions(char *array_spec) {
    int count = 0;
    for(int i = 0; array_spec[i]; i++) {
        if(array_spec[i] == '[') count++;
    }
    return count;
}
