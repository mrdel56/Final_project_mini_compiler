...
{
       0,    90,    90,    91,    91,    92,    92,    93,    93,    94,
      94,    94,    94,    94,    95,    95,    96,    96,    96,    96,
      96,    99,   100,   101,   102,   106,   107,   114,   120,   114,
     132,   132,   135,   140,   135,   151,   151,   153,   156,   156,
     157,   157,   158,   158,   161,   162,   163,   167,   168,   169,
     173,   174,   175,   176,   177
};
#endif
...
#line 1286 "task7_parser.c"
    break;

  case 28: /* $@2: %empty  */
#line 120 "task7_parser.y"
                              {
        char *Lend = new_label();
        gen("goto", "", "", Lend);
...
#line 1318 "task7_parser.c"
    break;

  case 33: /* $@4: %empty  */
#line 140 "task7_parser.y"
                              {
        char *Lend = new_label();
        gen("ifFalse", (yyvsp[-1].str), "", Lend);
        strcpy(stack[sp].end_label, Lend);
    }
#line 1328 "task7_parser.c"
    break;

  case 34: /* while_stmt: WHILE $@3 LPAREN condition RPAREN $@4 LBRACE stmt_list RBRACE  */
#line 144 "task7_parser.y"
                              {
        gen("goto", "", "", stack[sp].false_label);
        gen("Label", "", "", stack[sp].end_label);
        sp--;
    }
#line 1338 "task7_parser.c"
    break;

  case 35: /* return_stmt: RETURN expr SEMI  */
#line 151 "task7_parser.y"
                              { gen("return", (yyvsp[-1].str), "", ""); }
#line 1344 "task7_parser.c"
    break;

  case 36: /* return_stmt: RETURN SEMI  */
#line 151 "task7_parser.y"
                                                                           { gen("return", "", "", ""); }
#line 1350 "task7_parser.c"
    break;

  case 37: /* condition: expr relop expr  */
#line 153 "task7_parser.y"
                           { char *tmp = new_temp(); gen((yyvsp[-1].str), (yyvsp[-2].str), (yyvsp[0].str), tmp); (yyval.str) = tmp; }
#line 1356 "task7_parser.c"
    break;

  case 38: /* relop: LT  */
#line 156 "task7_parser.y"
       { (yyval.str) = strdup("<"); }
#line 1362 "task7_parser.c"
    break;

  case 39: /* relop: GT  */
#line 156 "task7_parser.y"
                                  { (yyval.str) = strdup(">"); }
#line 1368 "task7_parser.c"
    break;

  case 40: /* relop: LE  */
#line 157 "task7_parser.y"
         { (yyval.str) = strdup("<="); }
#line 1374 "task7_parser.c"
    break;

  case 41: /* relop: GE  */
#line 157 "task7_parser.y"
                                     { (yyval.str) = strdup(">="); }
#line 1380 "task7_parser.c"
    break;

  case 42: /* relop: EQ  */
#line 158 "task7_parser.y"
         { (yyval.str) = strdup("=="); }
#line 1386 "task7_parser.c"
    break;

  case 43: /* relop: NE  */
#line 158 "task7_parser.y"
                                     { (yyval.str) = strdup("!="); }
#line 1392 "task7_parser.c"
    break;

  case 44: /* expr: expr PLUS term  */
#line 161 "task7_parser.y"
                   { char *tmp = new_temp(); gen("+", (yyvsp[-2].str), (yyvsp[0].str), tmp); (yyval.str) = tmp; }
#line 1398 "task7_parser.c"
    break;

  case 45: /* expr: expr MINUS term  */
#line 162 "task7_parser.y"
                      { char *tmp = new_temp(); gen("-", (yyvsp[-2].str), (yyvsp[0].str), tmp); (yyval.str) = tmp; }
#line 1404 "task7_parser.c"
    break;

  case 46: /* expr: term  */
#line 163 "task7_parser.y"
           { (yyval.str) = (yyvsp[0].str); }
#line 1410 "task7_parser.c"
    break;

  case 47: /* term: term MUL factor  */
#line 167 "task7_parser.y"
                    { char *tmp = new_temp(); gen("*", (yyvsp[-2].str), (yyvsp[0].str), tmp); (yyval.str) = tmp; }
#line 1416 "task7_parser.c"
    break;

  case 48: /* term: term DIV factor  */
#line 168 "task7_parser.y"
                      { char *tmp = new_temp(); gen("/", (yyvsp[-2].str), (yyvsp[0].str), tmp); (yyval.str) = tmp; }
#line 1422 "task7_parser.c"
    break;

  case 49: /* term: factor  */
#line 169 "task7_parser.y"
             { (yyval.str) = (yyvsp[0].str); }
#line 1428 "task7_parser.c"
    break;

  case 50: /* factor: LPAREN expr RPAREN  */
#line 173 "task7_parser.y"
                       { (yyval.str) = (yyvsp[-1].str); }
#line 1434 "task7_parser.c"
    break;

  case 51: /* factor: ID  */
#line 174 "task7_parser.y"
         { (yyval.str) = (yyvsp[0].str); }
#line 1440 "task7_parser.c"
    break;

  case 52: /* factor: NUM  */
#line 175 "task7_parser.y"
          { char *buf = (char*)malloc(16); sprintf(buf, "%d", (yyvsp[0].num)); (yyval.str) = buf; }
#line 1446 "task7_parser.c"
    break;

  case 53: /* factor: FLOAT_NUM  */
#line 176 "task7_parser.y"
                { char *buf = (char*)malloc(16); sprintf(buf, "%.2f", (yyvsp[0].fnum)); (yyval.str) = buf; }
#line 1452 "task7_parser.c"
    break;

  case 54: /* factor: ID LBRACKET expr RBRACKET  */
#line 177 "task7_parser.y"
                                { char *buf = (char*)malloc(64); sprintf(buf, "%s[%s]", (yyvsp[-3].str), (yyvsp[-1].str)); (yyval.str) = buf; }
#line 1458 "task7_parser.c"
    break;


#line 1462 "task7_parser.c"
...
void update_var(const char *name, int value, int is_const) {
    ...
    if (idx == -1) {
        ...
        var_table[var_count].reg_num = var_count;
        var_count++;
    } else {
                ...
                for (int j = i + 1; j < tac_count; j++) {
                    if (strcmp(tac[j].op, "goto") == 0) {
                        ...
                        for (int k = j + 1; k < tac_count; k++) {
                            if (!tac[k].is_dead) {
                                if (strcmp(tac[k].op, "Label") == 0 && strcmp(tac[k].result, goto_target) == 0) {
                                    tac[j].is_dead = 1;
                                }
                                break;
                            }
                    ...
                    if (strcmp(tac[j].op, "Label") == 0 && strcmp(tac[j].result, dead_label) == 0) {
                        break;
                    }
                }
            }
...
void generate_arm_assembly() {
    printf("\n===============================================================\n");
    printf("                  ARM ASSEMBLY CODE OUTPUT\n");
    printf("===============================================================\n\n");
    
    printf(".text\n");
    printf("MOV R0,=1\n");
    
    // Assign unique registers to each variable
    for (int i = 0; i < var_count; i++) {
        var_table[i].reg_num = i + 1;  // R1, R2, R3, etc.
    }
    
    int temp_reg = 10;  // Use R10+ for temporary operations
    ...
    for (int i = 0; i < tac_count; i++) {
        ...
        if (strcmp(tac[i].op, "=") == 0) {
            ...
            int dest_idx = find_var(tac[i].result);
            
            if (is_constant(tac[i].arg1)) {
                // dest = constant
                printf("MOV R%d,=%s\n", var_table[dest_idx].reg_num, tac[i].arg1);
            } else {
                // dest = variable
                int src_idx = find_var(tac[i].arg1);
                if (src_idx >= 0) {
                    printf("MOV R%d,R%d\n", var_table[dest_idx].reg_num, var_table[src_idx].reg_num);
                }
            }
        }
        else if (strcmp(tac[i].op, "+") == 0) {
            // result = arg1 + arg2
            int res_idx = find_var(tac[i].result);
            int arg1_idx = find_var(tac[i].arg1);
            
            if (is_constant(tac[i].arg2)) {
                printf("ADD R%d,R%d,#%s\n", 
                       var_table[res_idx].reg_num,
                       var_table[arg1_idx].reg_num,
                       tac[i].arg2);
            } else {
                int arg2_idx = find_var(tac[i].arg2);
                printf("ADD R%d,R%d,R%d\n",
                       var_table[res_idx].reg_num,
                       var_table[arg1_idx].reg_num,
                       var_table[arg2_idx].reg_num);
            }
        }
        else if (strcmp(tac[i].op, "-") == 0) {
            // result = arg1 - arg2
            ...
            // ARM doesn't have DIV in older versions, use SDIV for ARMv7+
            ...
            int cond_idx = find_var(tac[i].arg1);
            printf("CMP R%d,#0\n", var_table[cond_idx].reg_num);
            printf("BEQ %s\n", tac[i].result);
        }
        else if (strcmp(tac[i].op, "return") == 0) {
            if (strlen(tac[i].arg1) > 0) {
                if (is_constant(tac[i].arg1)) {
                    ...
                    int ret_idx = find_var(tac[i].arg1);
                    printf("MOV R0,R%d\n", var_table[ret_idx].reg_num);
                }
            }
        }
    }
    ...
    printf("\n===============================================================\n");
    printf("✓ ARM Assembly code generated successfully!\n");
    printf("===============================================================\n");
}
...
int main(int argc, char *argv[]) {
    ...
    printf("===============================================================\n");
    printf("   TASK 7: COMPLETE COMPILER (TAC + OPTIMIZATION + ARM ASM)\n");
    printf("===============================================================\n\n");
